...
/**
 * Clase que representa el menú principal de la aplicación de restaurante.
 * Permite al usuario seleccionar pizzas y agregarlas al carrito.
 * 
 * @author ortun
 */
public class MenuPrincipal extends javax.swing.JFrame {
    private final Carrito carrito; // Objeto que maneja el carrito de compras
    
     // Lista estática que almacena las pizzas agregadas al carrito
    public static ArrayList<Pizza> carritoPizzas = new ArrayList<>();

    
    /**
     * Crea una nueva instancia de la ventana del menú principal.
     * Inicializa los componentes gráficos y ajusta la posición de la ventana al centro.
     */
    public MenuPrincipal() {
        initComponents();
        this.setLocationRelativeTo(null);
        carrito = new Carrito(); // Inicializa el carrito de compras
        
    }
    
    /**
     * Calcula el precio de la pizza en función de su tipo y tamaño.
     * El precio base depende del tipo de pizza, y luego se ajusta según el tamaño seleccionado.
     * 
     * @param tipoPizza El tipo de pizza (Española, Napolitana, etc.).
     * @param tamaño El tamaño de la pizza (Mediana o Grande).
     * @return El precio calculado de la pizza.
     */
     private double calcularPrecio(String tipoPizza, String tamaño) {
        double basePrice = 0.0;
        // Establece el precio base en función del tipo de pizza
        switch (tipoPizza) {
            case "Española":
                basePrice = 40.0;
                break;
        ...
        // Ajusta el precio según el tamaño de la pizza
        switch (tamaño) {
            case "Mediana":
                basePrice += 10.0;
                break;
        ...
        return basePrice; // Devuelve el precio calculado
    }
    ...
    private void initComponents() {
        ...
        boxHawaiana.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pequeña - 40", "Mediana - 50 ", "Grande - 60" }));
        ...
        boxBoloñesa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pequeña - 40", "Mediana - 50 ", "Grande - 60" }));
        ...
        boxFunghi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pequeña - 40", "Mediana - 50 ", "Grande - 60" }));
        ...
        panelFunghiLayout.setHorizontalGroup(
            ...
            .addGroup(panelFunghiLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(panelFunghiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        boxNapolitana.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pequeña - 40", "Mediana - 50 ", "Grande - 60" }));
        ...
        panelNapolitanaLayout.setHorizontalGroup(
            ...
            .addGroup(panelNapolitanaLayout.createSequentialGroup()
                .addGroup(panelNapolitanaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelNapolitanaLayout.createSequentialGroup()
                        .addContainerGap()
        ...
        boxEspañola.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pequeña - 40", "Mediana - 50 ", "Grande - 60" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(panelFunghi, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
                            .addComponent(panelEspañola, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(25, 25, 25)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(panelBoloñesa, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(panelHawaiana, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(panelNapolitana, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    /**
     * Acción que ocurre cuando se presiona el botón "Salir".
     * Cierra la ventana del menú principal y abre la ventana de inicio de sesión.
     * 
    ...
    private void btn_SalirMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SalirMenuActionPerformed
        ...
        new Login().setVisible(true);// Abre la ventana de inicio de sesión
    }//GEN-LAST:event_btn_SalirMenuActionPerformed
    /**
     * Acción que ocurre cuando se presiona el botón "Carrito".
     * Abre la ventana que muestra el contenido del carrito de compras.
     * 
     * @param evt El evento de acción que dispara este método.
     */
    private void btn_CarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CarritoActionPerformed
        CarritoFrame carritoFrame = new CarritoFrame(); // Crea la ventana del carrito
        carritoFrame.setVisible(true); // Muestra la ventana del carrito
    ...
    private void btnAgregarNapolitanaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarNapolitanaActionPerformed
        // Obtener el tamaño seleccionado de la pizza Napolitana
    ...
    private void btnAgregarBoloñesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarBoloñesaActionPerformed
        // Obtener el tamaño seleccionado de la pizza Boloñesa
    ...
    private void btnAgregarHawaianaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarHawaianaActionPerformed
         // Obtener el tamaño seleccionado de la pizza Hawaiana
    ...
    private void btnAgregarFunghiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarFunghiActionPerformed
        // Obtener el tamaño seleccionado de la pizza Funghi
