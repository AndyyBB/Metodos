...
public class EditarTarea extends javax.swing.JFrame {
    ...
    // Constructor de EditarTarea que recibe los datos
    // Constructor de EditarTarea que recibe los datos
public EditarTarea(jPanelListaTareas panelListaTareas, String nombreUsuario, String nombreTarea, 
    ...
    // Método para cargar los usuarios en el ComboBox desde el archivo
    ...
    // Método para obtener los usuarios desde el archivo tareas.txt
    private List<String> obtenerUsuariosDesdeArchivo() {
        List<String> usuarios = new ArrayList<>();
        String rutaArchivo = "C:\\Users\\MI EQUIPO\\Gestion de Tareas\\tareas.txt";  // Ruta de tu archivo
  ...
  // Obtener los nuevos datos desde los campos
    String usuario = (String) cmbUsuariosEditarTarea.getSelectedItem();
    String nombreTarea = txtNombreEditarTarea.getText();
    String descripcion = txtDescripcionEditarTarea.getText();
    String prioridad = (String) boxPrioridadEditarTarea.getSelectedItem();
    String estado = (String) boxEstadoEditarTarea.getSelectedItem();
    String fechaInicio = txtFechaInicioEditarTarea.getText(); // Nuevo campo
    String fechaFin = txtFechaFinEditarTarea.getText();       // Nuevo campo

    // Verifica que todos los campos estén completos
    if (usuario.isEmpty() || nombreTarea.isEmpty() || descripcion.isEmpty() || fechaInicio.isEmpty() || fechaFin.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Por favor, complete todos los campos.");
        return;
    }

    // Ruta al archivo de tareas
    String rutaArchivo = "C:\\Users\\MI EQUIPO\\Gestion de Tareas\\tareas.txt";
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(archivo))) {
        ...
        while ((linea = reader.readLine()) != null) {
            ...
            // Comparamos el nombre de usuario y nombre de tarea
            if (datos.length >= 7 && datos[0].equals(usuario) && datos[1].equals(nombreTarea)) {
                // Si encuentra la tarea, reemplaza la línea con los nuevos datos
                nuevoContenido.append(usuario).append(";")
                        .append(nombreTarea).append(";")
                        .append(descripcion).append(";")
                        .append(prioridad).append(";")
                        .append(estado).append(";")
                        .append(fechaInicio).append(";") // Nueva fecha inicio
